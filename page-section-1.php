	...
	<main class="page-section-1">
		<section class="main-genplan">
			...
			<svg class="main-genplan-svg" style="background-image: url(img/genplan/main-genplan.jpg);" width="1920" height="1080" viewBox="0 0 1920 1080">
				<a xlink:href="category-section-floors.php" class="genplan-link" id="genplan-link-section1" data-description="Секція 1">
				...
				<a xlink:href="category-section-floors.php" class="genplan-link" id="genplan-link-section2" data-description="Секція 2">
