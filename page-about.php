	...
	<main class="page-about">
		...
		<section class="infrastructure">
			<ul class="infrastructure-navigation-list animation-elementY">
				...
				<li class="products-btn">
					<span>Продукти</span>
				</li>
				<li class="sports-btn">
					<span>Спорт</span>
				</li>
				<li class="hospital-btn">
					<span>Клініка</span>
				</li>
				<li class="relax-btn">
					<span>Розваги</span>
			...
			<div class="infrastructure-map animation-element">
				...
				<ul class="infrastructure-list infr-restaurants-list">
					<li class="ifr-item-restaurant-1">
						<span class="infr-icon">
							<img src="img/about/infrastructure/restaurants-icon.svg" alt="">
						</span>
					</li>
					<li class="ifr-item-restaurant-2">
						<span class="infr-icon">
							<img src="img/about/infrastructure/restaurants-icon.svg" alt="">
						</span>
					</li>										
				</ul>
				<ul class="infrastructure-list infr-products-list">
					<li class="ifr-item-products-1">
						<span class="infr-icon">
							<img src="img/about/infrastructure/products-icon.svg" alt="">
						</span>
					</li>										
				</ul>
				<ul class="infrastructure-list infr-sports-list">
					<li class="ifr-item-sports-1">
						<span class="infr-icon">
							<img src="img/about/infrastructure/sports-icon.svg" alt="">
						</span>
					</li>										
				</ul>
				<ul class="infrastructure-list infr-parks-list">
					<li class="ifr-item-parks-1">
						<span class="infr-icon">
							<img src="img/about/infrastructure/parks-icon.svg" alt="">
						</span>
					</li>										
				</ul>													
			</div>
					...
					<li>
						<a href="#" target="_blank">
							<div class="documents-img-container">
								<img src="img/about/doc1.jpg" alt="">
							</div>
							<h3>Дозвіл на виконання будівельних робіт №2843-Шв/Т</h3>
						</a>
					</li>
					<li>
						<a href="#" target="_blank">
