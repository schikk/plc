<? include("header.php") ?>
	<main class="page-remodeled">
		<section class="remodeled-intro">
			<div class="section-bg-img">
				<img src="img/remodeled/remodeled-intro.jpg" alt="">
					...
					<li>
						<div class="sign-quality-item-heading-container">
							<div class="sign-quality-icon-container">
								<img src="img/certificate/air-icon-black.svg" alt="">
							</div>
							<h4 class="remodeled-item-title">Стильні рішення</h4>
						</div>
						<p class="remodeled-item-descr">Комфортному і природного освітлення всіх приміщень будівлі сприяє як сама архітектура об'єкта, так і панорамні вікна.</p>
					</li>
					<li>
						<div class="sign-quality-item-heading-container">
							<div class="sign-quality-icon-container">
								<img src="img/elements/repairs-icon.svg" alt="">
							</div>
							<h4 class="remodeled-item-title">Готовий ремонт</h4>
						</div>
						<p class="remodeled-item-descr">Комфортному і природного освітлення всіх приміщень будівлі сприяє як сама архітектура об'єкта, так і панорамні вікна.</p>
					</li>
					<li>
						<div class="sign-quality-item-heading-container">
							<div class="sign-quality-icon-container">
								<img src="img/elements/furniture-icon.svg" alt="">
							</div>
							<h4 class="remodeled-item-title">Меблі і техніка</h4>
						</div>
						<p class="remodeled-item-descr">Комфортному і природного освітлення всіх приміщень будівлі сприяє як сама архітектура об'єкта, так і панорамні вікна.</p>
					</li>														
				</ul>
		...
		<section class="comparison white-section animation-element">
			<div class="comparison-slider-wrapper">
				<div id="visual-impact">
					...
					<img src="img/remodeled/after.jpg" alt="compare">
				</div>
				<span class="comparison-style left">Стиль 1</span>
		...
		<section class="comparison-style-description comparison-style1-descr white-section" id="comparison-style1">
			...
			<ul class="styles-list animation-element">
				...
				<li>
					<div class="style-img-container-wrapper rellax-delayed" data-rellax-speed="2" data-rellax-percentage="0.5">
	    				<div class="style-img-container" data-markers="[{x: '49', y: '5', title: '', description: 'Два шари фарби CAPAROL'}, {x: '67', y: '10', title: '', description: 'Стильні світильники Nowodvorski'}, {x: '18', y: '25', title: '', description: 'Два шари фарби CAPAROL'}, {x: '18', y: '90', title: '', description: 'Екологічно чистий ламінат KAINDL'}]">
	    					<img src="img/remodeled/before.jpg" alt="compare">
	    				</div>
					</div>
				</li>
				<li>
					<div class="style-img-container-wrapper rellax-delayed" data-rellax-speed="2" data-rellax-percentage="0.5">
	    				<div class="style-img-container" data-markers="[{x: '50', y: '5', title: '', description: '	Натяжна стеля'}, {x: '17', y: '26', title: '', description: 'Змішувач виробництва Grohe'}, {x: '50', y: '26', title: '', description: 'Керамогранітна плитка'}, {x: '17', y: '65', title: '', description: 'Умивальник виробництва Cersanit зі змішувачем Grohe'}, {x: '80', y: '80', title: '', description: 'Унітаз з інсталяцією Villeroy & Bosh'}, {x: '51', y: '95', title: '', description: 'Керамогранітна плитка для підлоги ZEUS CERAMICA'}]">
	    					<img src="img/remodeled/before.jpg" alt="compare">
	    				</div>
					</div>
				</li>
			...
			<div class="style-info-collapsable">
				<ul class="style-info-collapsable-list">
					<li>
						<h3>Стеля</h3>
					...
					<li>
						<h3>Двері</h3>
						<p>Мінеральна вата Rockwool товщиною від 150 мм</p>
						<p>Мінеральна вата Rockwool товщиною від 150 мм</p>
						<p>Мінеральна вата Rockwool товщиною від 150 мм</p>
					</li>
					<li>
						<h3>Роботи з сантехніки</h3>
		...
		<section class="remodel-price-section animation-element">
			<div class="remodel-price-left-col">
				<div class="remodel-price-left-col-form-wrapper">
					...
					<form action="#" id="form-feedback-remodeled">
						<div class="input-wrapper">
							<input class="forms-input" type="text" id="client-name-remodeled" name="client-name" placeholder="Ваше ім’я" autocomplete="off">
							<span class="wrong-mssg">Введіть коректне ім’я</span>
						</div>
						<div class="input-wrapper">
							<input class="forms-input" type="tel" id="client-phone-remodeled" name="client-phone" placeholder="Ваш телефон" autocomplete="off">
							<span class="wrong-mssg">Ви не ввели номер телефону</span>
						</div>
						<div class="input-wrapper">
							<input class="forms-input" type="email" id="client-phone-remodeled" name="client-email" placeholder="Ваш e-mail" autocomplete="off">
						</div>					
						<span class="plc-btn green-btn remodel-price-order-btn">
		                    <input id="order-button-remodeled" type="submit">
			...
			<div class="remodel-price-right-col">
				<img src="img/remodeled/price.jpg" alt="">
				<div class="remodel-price-right-col-content">
					<h2>Ціна квартири з ремонтом</h2>
					<span class="remodel-price">1200 $ <span>за м²</span></span>
